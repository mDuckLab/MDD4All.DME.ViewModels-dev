...
{
    // Kept for a possible future browser-hosted deployment (uses IBrowserFile/IFileSaveService instead of native file dialogs) - not wired into the current WPF app.
    public class WebDataManagerViewModel : ObservableObject
    {
        private readonly DataEditorViewModel _objectJsonManager;
        private readonly IFileSaveService _fileSaveService;
        //private readonly IFileImportService _fileImportService;

        public WebDataManagerViewModel(DataEditorViewModel dataManager, IFileSaveService fileSaveService/*, IFileImportService fileImportService*/)
        {
